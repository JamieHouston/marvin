...
def add_to_lunch(bot_input, bot_output):
	...
	result = web.get_json("http://lunchpad.hq.daptiv.com/restaurant/" + bot_input.groupdict()["rest"] + "/add/" + email)
	bot_output('added you to restaurant')


@hook.regex(r'lunchbot.*')
def lunch(bot_input, bot_output):
    rests = web.get_json("http://lunchpad.hq.daptiv.com/restaurants/trending:3000")
    to_say = []
