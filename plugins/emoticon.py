...
emojis = {
    ...
    "wink": ["face", "happy", "mischievous", "secret"],
    "heart_eyes": ["face", "love", "like", "affection", "valentines", "infatuation", "crush"],
    "kissing_heart": ["face", "love", "like", "affection", "valentines", "infatuation"],
    "kissing_closed_eyes": ["face", "love", "like", "affection", "valentines", "infatuation"],
    "kissing": ["love", "like", "face", "3", "valentines", "infatuation"],
    "kissing_smiling_eyes": ["face", "affection", "valentines", "infatuation"],
    "stuck_out_tongue_winking_eye": ["face", "prank", "childish", "playful", "mischievous", "smile"],
    "stuck_out_tongue_closed_eyes": ["face", "prank", "playful", "mischievous", "smile"],
    "stuck_out_tongue": ["face", "prank", "childish", "playful", "mischievous", "smile"],
    "flushed": ["face", "blush", "shy", "flattered"],
    "grin": ["face", "happy", "smile", "joy"],
    "pensive": ["face", "sad", "depressed", "okay", "upset"],
    "relieved": ["face", "relaxed", "phew", "massage", "happiness"],
    "unamused": ["indifference", "bored", "straight face", "serious"],
    ...
    "sweat_smile": ["face", "hot", "happy", "laugh"],
    ...
    "yum": ["happy", "joy", "tongue", "smile", "face", "silly"],
    "mask": ["face", "sick", "ill", "disease"],
    "sunglasses": ["face", "cool", "smile", "summer"],
    "sleeping": ["face", "tired", "sleepy", "night", "zzz"],
    "dizzy_face": ["spent", "unconscious", "xox"],
    ...
    "expressionless": ["face", "indifferent", "-_-", "meh"],
    "man_with_gua_pi_mao": ["male", "boy"],
    "man_with_turban": ["male", "indian", "hinduism", "arabs"],
    "cop": ["man", "police", "law", "legal", "enforcement", "arrest", "911"],
    "construction_worker": ["male", "human", "wip", "guy"],
    "guardsman": ["uk", "gb", "british", "male", "guy", "royal"],
    "baby": ["child", "boy", "girl", "toddler"],
    "boy": ["man", "male", "guy", "teenager"],
    "girl": ["female", "woman", "teenager"],
    "man": ["mustache", "father", "dad", "guy", "classy", "sir"],
    "woman": ["female", "girls", "lady"],
    "older_man": ["human", "male", "men"],
    "older_woman": ["female", "women", "girl", "lady"],
    "person_with_blond_hair": ["man", "male", "boy", "blonde", "guy"],
    ...
    "scream_cat": ["animal", "cats", "munch", "scared"],
    "crying_cat_face": ["animal", "tears", "weep", "sad", "cats", "upset"],
    "joy_cat": ["animal", "cats", "haha", "happy", "tears"],
    "pouting_cat": ["animal", "cats"],
    "smiley_cat": ["animal", "cats", "happy"],
    "japanese_goblin": ["red", "evil", "mask", "monster", "scary", "creepy"],
    "see_no_evil": ["monkey", "animal", "nature", "haha"],
    "hear_no_evil": ["animal", "monkey", "nature"],
    "speak_no_evil": ["monkey", "animal", "nature", "omg"],
    "skull": ["dead", "skeleton", "creepy"],
    "alien": ["UFO", "paul"],
    "hankey": ["poop", "shitface"],
    "poop": ["shitface"],
    "shit": ["poop", "shitface"],
    "fire": ["hot", "cook", "flame"],
    "sparkles": ["stars", "shine", "shiny", "cool", "awesome", "good"],
    "star2": ["night", "sparkle", "awesome", "good"],
    "dizzy": ["star", "sparkle", "shoot"],
    "boom": ["bomb", "explode", "explosion"],
    "collision": ["boom", "bomb", "blown"],
    "anger": ["angry", "mad"],
    "sweat_drops": ["water", "drip"],
    ...
    "thumbsup": ["cool", "hand", "yes", "like"],
    "-1": ["thumbsdown", "no", "dislike"],
    "thumbsdown": ["hand", "no", "dislike"],
    "ok_hand": ["fingers", "limbs", "perfect"],
    "punch": ["hand", "fist"],
    "facepunch": ["angry", "violence", "fist", "hit", "attack"],
    "fist": ["fingers", "hand", "grasp"],
    "v": ["fingers", "ohyeah", "hand", "peace", "victory", "two"],
    "wave": ["hands", "gesture", "goodbye", "solong", "farewell", "hello", "palm"],
    ...
    "raised_hands": ["gesture", "hooray", "yea", "celebration"],
    "pray": ["please", "hope", "wish", "namaste", "highfive"],
    "point_up_2": ["fingers", "hand", "direction"],
    "clap": ["hands", "praise", "applause", "congrats", "yay"],
    "muscle": ["arm", "flex", "hand", "summer", "strong"],
    "walking": ["human", "feet", "steps"],
    "runner": ["man", "walking", "exercise", "race"],
    "running": ["man", "walking", "exercise", "fun", "race"],
    ...
    "couplekiss": ["pair", "valentines", "love", "like", "dating", "marriage"],
    ...
    "no_good": ["female", "girl", "woman", "nope"],
    "information_desk_person": ["female", "girl", "woman", "human"],
    "raised_hand": ["female", "girl", "woman", "ban", "palm"],
    "massage": ["female", "girl", "woman", "head"],
    "haircut": ["female", "girl", "woman"],
    "nail_care": ["beauty", "manicure"],
    "bride_with_veil": ["couple", "marriage", "wedding"],
    "person_with_pouting_face": ["female", "girl", "woman"],
    "person_frowning": ["female", "girl", "woman", "sad", "depressed", "discouraged", "unhappy"],
    "bow": ["man", "male", "boy"],
    "tophat": ["magic", "gentleman", "classy"],
    "crown": ["king", "kod", "leader", "royalty", "lord"],
    "womans_hat": ["fashion", "accessories", "female", "lady"],
    "athletic_shoe": ["shoes", "sports"],
    "shoe": ["accessories", "fashion"],
    "mans_shoe": ["fashion", "male"],
    "sandal": ["shoes", "fashion"],
    "high_heel": ["fashion", "shoes", "female", "pumps"],
    "boot": ["shoes", "fashion"],
    "tshirt": ["cloth", "fashion", "casual"],
    "shirt": ["fashion", "cloth"],
    "necktie": ["shirt", "suitup", "formal", "fashion", "cloth", "business"],
    "womans_clothes": ["fashion", "shopping", "female"],
    ...
    "briefcase": ["business", "documents", "work", "law", "legal"],
    "handbag": ["fashion", "accessory", "accessories"],
    "pouch": ["bag", "accessories"],
    "purse": ["fashion", "accessories", "money", "sales"],
    "eyeglasses": ["fashion", "accessories", "eyesight", "nerd", "dork"],
    ...
    "broken_heart": ["sad", "sorry", "break"],
    "heartpulse": ["like", "love", "affection", "valentines", "pink"],
    "heartbeat": ["love", "like", "affection", "valentines", "pink"],
    ...
    "ring": ["wedding", "propose", "marriage", "valentines", "diamond"],
    "gem": ["blue", "ruby", "diamond"],
    ...
    "footprints": ["feet", "tracking", "walking"],
    "thought_balloon": ["bubble", "cloud", "speech", "thinking"],
    "dog": ["animal", "friend", "nature", "woof", "puppy", "pet", "faithful"],
    "wolf": ["animal", "nature", "wild"],
    "cat": ["animal", "meow", "nature", "pet"],
    "mouse": ["animal", "nature", "cheese"],
    "hamster": ["animal", "nature"],
    "rabbit": ["animal", "nature", "pet"],
    ...
    "boar": ["animal", "nature"],
    "monkey": ["animal", "nature", "banana"],
    "monkey_face": ["animal", "nature"],
    "horse": ["animal", "brown", "nature", "unicorn"],
    "sheep": ["animal", "nature", "wool", "shipit"],
    "elephant": ["animal", "nature", "nose", "thailand"],
    "panda_face": ["animal", "nature"],
    "penguin": ["animal", "nature"],
    "bird": ["animal", "nature", "fly", "tweet"],
    "baby_chick": ["animal", "chicken"],
    "hatched_chick": ["animal", "chicken", "baby"],
    "hatching_chick": ["animal", "chicken", "egg", "born"],
    "chicken": ["animal", "cluck", "nature"],
    "snake": ["animal", "evil", "nature", "hiss"],
    "turtle": ["animal", "slow", "nature", "tortoise"],
    "bug": ["insect", "nature", "worm"],
    "honeybee": ["animal", "insect", "nature"],
    "bee": ["animal", "insect", "nature"],
    "ant": ["animal", "insect", "nature"],
    "beetle": ["insect", "nature"],
    "snail": ["slow", "animal", "shell"],
    "octopus": ["animal", "creature", "ocean", "sea", "nature"],
    "shell": ["nature", "sea", "beach"],
    "tropical_fish": ["animal", "swim", "ocean"],
    "fish": ["animal", "food", "nature"],
    "dolphin": ["animal", "nature", "fish", "sea", "ocean", "flipper", "fins"],
    ...
    "maple_leaf": ["nature", "plant", "vegetable", "canada"],
    ...
    "palm_tree": ["plant", "vegetable", "nature", "summer"],
    ...
    "globe_with_meridians": ["earth", "international", "world", "internet", "interweb"],
    ...
    "moon": ["nature", "night", "sky", "gray", "twilight", "planet", "space", "evening", "sleep"],
    "full_moon": ["nature", "yellow", "twilight", "planet", "space", "night", "evening", "sleep"],
    "waning_gibbous_moon": ["nature", "twilight", "planet", "space", "night", "evening", "sleep"],
    ...
    "crescent_moon": ["night", "sleep", "sky", "evening"],
    ...
    "stars": ["night", "photo"],
    "star": ["night", "yellow"],
    "sunny": ["weather", "nature", "brightness", "summer"],
    "partly_sunny": ["weather", "nature", "cloudy", "morning"],
    "cloud": ["weather", "sky"],
    "zap": ["thunder", "weather", "lightning bolt"],
    ...
    "100": ["score", "perfect", "numbers", "century"],
    "1234": ["numbers", "blue-square"],
    "8ball": ["pool", "hobby", "game"],
    ...
    "closed_book": ["read", "library", "knowledge", "textbook"],
    ...
    "confetti_ball": ["festival", "party", "birthday"],
    ...
    "heavy_dollar_sign": ["money", "sales", "payment", "currency"],
    "heavy_exclamation_mark": ["surprise", "danger", "punctuation", "warning"],
    "heavy_minus_sign": ["math", "calculation", "subtract", "less"],
    "heavy_multiplication_x": ["math", "calculation"],
    "notes": ["music", "score"],
    "nut_and_bolt": ["handy", "tools"],
    "o": ["circle", "round"],
    "o2": ["alphabet", "red-square", "letter"],
    "octocat": ["animal", "octopus", "github", "ghonly"],
    "oden": ["food", "japanese"],
    ...
    "soccer": ["sports", "balls", "football", "fifa"],
    "soon": ["arrow", "words"],
    ...
    "arrow_lower_left": ["blue-square"],
    "hotsprings": ["bath", "warm", "relax"],
    "strawberry": ["fruit", "food", "nature"],
    "arrow_lower_right": ["blue-square"],
    "credit_card": ["money", "sales", "dollar", "bill", "payment"],
    ...
    "arrow_right_hook": ["blue-square", "return", "rotade", "direction"],
    "house": ["building", "home"],
    ...
    "hurtrealbad": ["mad", "injured", "doom", "oldschool"],
    "passport_control": ["custom", "blue-square"],
    "arrow_up_small": ["blue-square", "triangle", "direction", "point", "forward"],
    "arrow_upper_left": ["blue-square", "point", "direction"],
    "ice_cream": ["food", "hot", "dessert"],
    "peach": ["fruit", "nature", "food"],
    "arrow_upper_right": ["blue-square", "point", "direction"],
    ...
    "pencil": ["stationery", "documents", "paper", "writing", "write"],
    "sunrise_over_mountains": ["view", "vacation", "photo"],
    "arrows_counterclockwise": ["blue-square", "sync", "cycle"],
    "curly_loop": ["scribble", "draw", "shape"],
    "ideograph_advantage": ["chinese", "kanji", "obtain", "get", "circle"],
    "pencil2": ["stationery", "write", "paper", "writing"],
    "surfer": ["sports", "ocean", "sea", "summer"],
    ...
    "tanabata_tree": ["plant", "nature", "branch"],
    "balloon": ["party", "celebration", "birthday"],
    "japanese_castle": ["photo", "building"],
    "pineapple": ["fruit", "nature", "food"],
    "tangerine": ["food", "fruit", "nature"],
    "ballot_box_with_check": ["ok", "agree", "confirm", "black-square", "vote", "election"],
    "department_store": ["building", "shopping", "mall"],
    "pisces": ["purple-square", "sign", "zodiac"],
    "taurus": ["purple-square", "sign", "zodiac"],
    "bamboo": ["plant", "nature", "vegetable", "panda"],
    "diamond_shape_with_a_dot_inside": ["jewel"],
    "japanese_ogre": ["monster", "red", "mask", "halloween", "scary", "creepy", "devil", "demon"],
    "pizza": ["food", "party"],
    ...
    "telephone": ["communication", "technology", "dial"],
    ...
    "kr": ["korea", "nation", "flag", "country", "banner"],
    "toilet": ["restroom", "wc", "washroom"],
    "bell": ["sound", "notification", "christmas", "xmas", "chime"],
    "lantern": ["light", "spooky"],
    ...
    "dvd": ["cd", "disk", "disc"],
    "large_blue_diamond": ["shape", "jewel"],
    "bike": ["sports", "bicycle", "exercise", "hipster"],
    "e-mail": ["communication", "inbox", "email"],
    "large_orange_diamond": ["shape", "jewel"],
    "top": ["words", "blue-square"],
    "pushpin": ["stationery", "mark", "here"],
    "tractor": ["vehicle", "car", "farming", "agriculture"],
    "birthday": ["party", "cake", "celebration"],
    "laughing": ["happy", "joy", "lol"],
    ...
    "black_joker": ["poker", "cards", "game", "play"],
    "ledger": ["notes", "paper"],
    ...
    "exclamation": ["surprise", "punctuation", "wow", "warning"],
    ...
    "restroom": ["blue-square", "toilet", "refresh", "wc"],
    ...
    "finnadie": ["ghonly", "doom", "oldschool"],
    ...
    "uk": ["british", "england", "union jack", "english", "flag", "country", "nation", "banner"],
    ...
    "rocket": ["launch", "ship", "staffmode", "NASA", "outer space"],
    ...
    "memo": ["documents", "stationery", "pencil", "paper", "writing", "legal"],
    "unlock": ["privacy", "security"],
    "fish_cake": ["food", "japan", "sea", "beach"],
    "mens": ["toilet", "restroom", "wc", "blue-square"],
    ...
    "floppy_disk": ["oldschool", "technology", "save", "90s"],
    "minibus": ["vehicle", "car", "transportation"],
    "video_camera": ["film", "record"],
    "cancer": ["sign", "zodiac", "purple-square"],
    "flower_playing_cards": ["game"],
    "minidisc": ["technology", "record", "data", "disk"],
    "video_game": ["play", "console", "PS4", "controller"],
    "candy": ["snack", "dessert", "sweet"],
    ...
    "sagittarius": ["sign", "zodiac", "purple-square"],
    "virgo": ["sign", "zodiac", "purple-square"],
    "capricorn": ["sign", "zodiac", "purple-square"],
    "football": ["sports", "balls", "NFL"],
    "moneybag": ["dollar", "payment", "coins", "sale"],
    "sailboat": ["transportation", "ship", "summer"],
    "car": ["transportation", "vehicle"],
    "sake": ["wine", "drink", "drunk", "beverage", "japanese"],
    ...
    "mortar_board": ["school", "college", "degree", "university", "graduation", "cap", "hat", "legal"],
    "warning": ["exclamation", "wip", "alert", "error", "problem", "issue"],
    "cd": ["technology", "dvd", "disk", "disc"],
    ...
    "mountain_bicyclist": ["transportation", "sports", "human", "race", "bike"],
    "school": ["building", "student", "education", "learn", "teach"],
    "chart_with_downwards_trend": ["graph", "presentation", "stats", "recession", "business", "economics", "money",
                                   "sales", "bad", "failure"],
    ...
    "chart_with_upwards_trend": ["graph", "presenetation", "stats", "recovery", "business", "economics", "money",
                                 "sales", "good", "success"],
    "fries": ["chips", "snack", "fast food"],
    "mountain_railway": ["transportation", "vehicle"],
    "scissors": ["stationery", "cut"],
    "checkered_flag": ["contest", "finishline", "rase", "gokart"],
    "scorpius": ["sign", "zodiac", "purple-square"],
    "wavy_dash": ["draw", "line"],
    "cherries": ["food", "fruit"],
    "fuelpump": ["gas station", "petroleum"],
    "movie_camera": ["film", "record"],
    "waxing_gibbous_moon": ["nature", "night", "sky"],
    "moyai": ["stone", "easter island"],
    "scroll": ["documents", "ancient", "history", "paper"],
    "wc": ["toilet", "restroom", "blue-square"],
    "seat": ["sit", "airplane", "transport", "bus", "flight"],
    "children_crossing": ["school", "warning", "danger", "sign", "driving", "yellow-diamond"],
    "game_die": ["dice", "random", "tabbletop", "play"],
    ...
    "gb": ["banner", "nation", "flag", "british", "UK", "country", "english"],
    "musical_keyboard": ["piano", "instrument"],
    "musical_note": ["score", "tone", "sound"],
    "church": ["building", "religion", "christ"],
    "gemini": ["sign", "zodiac", "purple-square"],
    "musical_score": ["treble", "clef"],
    ...
    "mute": ["sound", "volume", "silence"],
    "shaved_ice": ["hot", "dessert", "summer"],
    "white_check_mark": ["green-square", "ok", "agree", "vote", "election"],
    ...
    "goberserk": ["ghonly", "doom", "rage", "bloody", "hurt"],
    ...
    "golf": ["sports", "business", "flag", "hole"],
    "shower": ["clean", "water", "bathroom"],
    "wind_chime": ["nature", "ding"],
    "clock10": ["time", "late", "early", "schedule"],
    "grapes": ["fruit", "food", "wine"],
    "signal_strength": ["blue-square", "reception", "phone", "internet", "connection", "wifi", "bluetooth"],
    "wine_glass": ["drink", "beverage", "drunk", "alcohol"],
    ...
    "clock12": ["time", "noon", "midnight", "late", "early", "schedule"],
    ...
    "womens": ["purple-square", "woman", "female", "toilet", "loo", "restroom"],
    ...
    "hammer": ["tools", "verdict", "judge", "done", "law", "legal", "ruling", "gavel"],
    "zero": ["0", "numbers", "blue-square", "null"],
    "clock6": ["time", "late", "early", "schedule", "dawn", "dusk"],
    "notebook": ["stationery", "record", "notes", "paper"],
    "clock630": ["time", "late", "early", "schedule"],
    "notebook_with_decorative_cover": ["classroom", "notes", "record", "paper"],
    "horse_racing": ["animal", "betting", "competition", "gambling"],
    "christmas_tree": ["festival", "vacation", "december", "xmas", "celebration"],
    "fu": ["fuck", "finger", "dislike", "thumbsdown", "disapprove", "no"]
}
